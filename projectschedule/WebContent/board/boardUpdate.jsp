...
<html>
<head>
<title>projectschedule/boardUpdate.jsp</title>
...
<script>
   function validCheck(){
      ...
      if(result){
         if("${board.id}" == "${loginId}"||"${loginId}" == "admin"){ //trim함수
    ...
    <div class="form-content">
      ...
      <input name="seq" value="${board.seq}" type="hidden"/>
        ...
        <div class="form-group">
          ...
          <div></div>
          <button type="button" onclick="validCheck()" style="margin-top:10px;">삭제</button>
        </div>
      </form>
    </div>
  </div>
