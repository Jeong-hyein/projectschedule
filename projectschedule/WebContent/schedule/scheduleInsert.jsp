...
<html>
<head>
<title>projectschedule/schedulInsert.jsp</title>
    ...
    <div class="form-content">
      <form name="frm" action="ScheduleInsert.do" method="post">
        ...
        <div class="form-group">
          ...
          <input type="text" id="sdate" name="sdate" required="required"/>
        </div>
       <div class="form-group">
       	  <label for="schedule">일정</label>
          <input type="text" id="schedule" name="schedule" required="required"/>
        </div>
        <div class="form-group">
          <label for="memo">메모</label>
          <textarea rows="10" cols="30" name="memo" id="memo"></textarea><br/>
        </div>
  		<div></div>
  		<div></div>
        <div class="form-group">
