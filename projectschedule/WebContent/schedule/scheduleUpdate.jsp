...
<html>
<head>
<title>projectschedule/schedulUpdate.jsp</title>
...
<script>
   function validCheck(){
      ...
      if(result){
         if("${schedule.id}" == "${loginId}"||"${loginId}" == "admin"){ //trim함수
            location.href="ScheduleDelete.do?seq=" + ${schedule.seq};
            return;
         } else {
            alert("본인이 아닙니다.")   
         }        
      ...
      <form name="frm" action="ScheduleUpdate.do" method="post">
       ...
       <div class="form-group">
        ...
        <div class="form-group">
          ...
          <textarea rows="10" cols="30" name="memo" id="memo" >${schedule.memo}</textarea><br/>
        </div>
  		<div></div>
  		<div></div>
        <div class="form-group">
        ...
        <div class="form-group">
        <button type="button" onclick="validCheck()">삭제</button>
        </div>
      </form>
    </div>
  </div>
