...
<html>
<head>
<title>projectschedule/memberUpdate.jsp</title>
</head>
<body>
      ...
      <form name="frm" action="MemberUpdate.do" method="post">
       ...
       <div class="form-group">
        ...
        <div class="form-group">
		  ...
		  <input type="radio" name="gender" value="f" <%if(member.getGender() !=null && member.getGender().indexOf("f")>=0) { %> checked="checked" <% } %>/> 여자 
        </div>
        <div class="form-group">
